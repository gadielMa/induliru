...
function BookingPage() {
  ...
  return <main className={`site${mirelle ? ' mirelle-site' : ''}${sardi ? ' sardi-site' : ''}`} style={{ '--accent': business.accent }}>
