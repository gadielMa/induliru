...
function BookingPage() {
  ...
  return <main className={`site${mirelle ? ' mirelle-site' : ''}`} style={{ '--accent': business.accent }}>
    ...
    {mirelle ? <>
      ...
      <section className="mirelle-contact"><span className="eyebrow">CONTATO</span><h2>Vamos conversar?</h2><p>Atendimento presencial e on-line.</p><div><a href="https://api.whatsapp.com/message/L3VCCOPOI7BLF1?autoload=1&app_absent=0&utm_source=ig" target="_blank" rel="noreferrer">WhatsApp <span>↗</span></a><a href="https://www.instagram.com/mirellesantiago.psi/" target="_blank" rel="noreferrer">Instagram <span>↗</span></a><a href="mailto:mirellesantiago.psi@gmail.com">mirellesantiago.psi@gmail.com <span>↗</span></a></div></section>
    </> : <>
