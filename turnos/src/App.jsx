...
function Home() {
  return <main className="directory"><span className="eyebrow">INDULIRU</span><h1>Reservas simples,<br />para profesionales reales.</h1><p>Elegí a tu profesional y reservá online.</p><Link className="button" to="/antonella-morselli">Reservar con Antonella</Link></main>;
}
...
function BookingPage() {
  ...
  if (!business) return <Status title="Cargando tu espacio de bienestar…" />;
