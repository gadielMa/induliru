...
function Home() {
  ...
  return <main className="platform">
    ...
    <section className="testimonials"><span className="eyebrow">{portuguese ? 'CLIENTES FELIZES' : 'CLIENTES FELICES'}</span><h2>{portuguese ? <>Negócios reais,<br />menos complicação.</> : <>Negocios reales,<br />menos vueltas.</>}</h2><div className="testimonial-grid"><figure><blockquote>{portuguese ? '“O aplicativo funciona muito bem. Meus clientes já podem escolher o horário sem precisar me escrever o tempo todo.”' : '“La aplicación anda genial. Mis clientes ya pueden elegir su horario sin escribirme a cada rato.”'}</blockquote><figcaption><strong>Brian</strong><span>BrianBarber</span></figcaption></figure><figure><blockquote>{portuguese ? '“Desde que uso a plataforma, aumentaram meus clientes de massagem. Agendar ficou muito mais fácil.”' : '“Desde que la uso aumentaron mis clientes de masajes. Reservar se volvió mucho más fácil.”'}</blockquote><figcaption><strong>Antonella</strong><span>{portuguese ? 'Massagista profissional' : 'Masajista profesional'}</span></figcaption></figure></div></section>
