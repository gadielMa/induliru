...
function BookingPage() {
  ...
  const bookingEnabled = business.services.length > 0;
  const displayedServices = bookingEnabled ? business.services : (Array.isArray(business.practice_areas) ? business.practice_areas : []);
