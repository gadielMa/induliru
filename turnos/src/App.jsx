...
function Home() {
  return <main className="platform">
    ...
    <section className="tutorial"><div className="section-heading"><span className="eyebrow">CONFIGURACIÓN SIMPLE</span><h2>Así se pone en marcha.</h2><p>El único paso técnico que necesitás hacer es crear tu link de Mercado Pago. Del resto nos ocupamos nosotros.</p></div><div className="payment-preview" aria-label="Vista previa de un link de pago de Mercado Pago"><div className="payment-check">✓</div><span>LINK DE PAGO</span><h3>Compartí tu link<br />para cobrar</h3><strong>$100.000</strong><p>https://mpago.la/tu-link</p><div className="payment-copy-button">▣ &nbsp; Copiar link</div><small>El tutorial completo llega por email al iniciar tu plataforma.</small></div></section>
