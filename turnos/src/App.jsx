  ...
  return <main className="platform">
    ...
    <section className="client-showcase">
      ...
      <div className="client-preview-grid">
        ...
        <Link className="client-preview-card miro-preview-card" to="/miro"><img src="/turnos/miro/miro-logo.png" alt="Vista previa de Óptica Miró" /><div><span>ÓPTICA</span><strong>Óptica Miró</strong><b>{portuguese ? 'Ver página' : 'Ver sitio'} <i>→</i></b></div></Link>
      </div>
    </section>
...
function BookingPage() {
  ...
  return <main className={`site${mirelle ? ' mirelle-site' : ''}${sardi ? ' sardi-site' : ''}${brian ? ' brian-site' : ''}${miro ? ' miro-site' : ''}`} style={{ '--accent': business.accent }}>
    ...
    {mirelle ? <>
      ...
      <section className="miro-hero"><div className="miro-hero-copy"><img src="/turnos/miro/miro-logo.png" alt="Óptica Miró" /><span className="eyebrow">ÓPTICA · VILLA DEL PARQUE</span><h1>Tu mirada,<br /><em>en buenas manos.</em></h1><p>Consulta óptica y asesoramiento personalizado para cuidar tu visión todos los días.</p><a className="miro-cta" href="#reserva">Reservar consulta <span>→</span></a></div><aside className="miro-contact-card"><span>ÓPTICA MIRÓ</span><p>Atención con turno previo.</p><a href="https://www.google.com/maps/search/?api=1&query=Av.+Francisco+Beiro+3268,+Villa+del+Parque,+CABA" target="_blank" rel="noreferrer"><img src="/MAPS_LOGO.png" alt="" />Av. Francisco Beiró 3268 <b>↗</b></a><a href="https://wa.me/5491166046476" target="_blank" rel="noreferrer"><img src="/turnos/WSP_LOGO.png" alt="" />+54 9 11 6604-6476 <b>↗</b></a></aside></section>
      <section className="miro-about"><span className="eyebrow">ÓPTICA MIRÓ</span><h2>Una consulta simple para ver mejor.</h2><p>Evaluamos tus necesidades visuales y te acompañamos con recomendaciones claras, cercanas y profesionales.</p></section>
    </> : <>
