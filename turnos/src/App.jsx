...
function BookingPage() {
  ...
  return <main className={`site${mirelle ? ' mirelle-site' : ''}${sardi ? ' sardi-site' : ''}${brian ? ' brian-site' : ''}${miro ? ' miro-site' : ''}`} style={{ '--accent': business.accent }}>
    ...
    {mirelle ? <>
      ...
      <section className="miro-hero"><div className="miro-hero-copy"><img src="/turnos/miro/miro-logo.png" alt="Óptica Miró" /><span className="eyebrow">ÓPTICA · RECOLETA</span><h1>Tu mirada,<br /><em>en buenas manos.</em></h1><p>Consulta óptica y asesoramiento personalizado para cuidar tu visión todos los días.</p><a className="miro-cta" href="#reserva">Reservar consulta <span>→</span></a></div><aside className="miro-contact-card"><span>ÓPTICA MIRÓ</span><p>Atención con turno previo.</p><a href="https://www.google.com/maps/search/?api=1&query=Recoleta,+CABA,+Argentina" target="_blank" rel="noreferrer"><img src="/MAPS_LOGO.png" alt="" />Recoleta, CABA <b>↗</b></a><a href="https://wa.me/5491154907428" target="_blank" rel="noreferrer"><img src="/turnos/WSP_LOGO.png" alt="" />Contactanos por WhatsApp <b>↗</b></a></aside></section>
